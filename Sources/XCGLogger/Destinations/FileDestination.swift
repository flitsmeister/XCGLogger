...
open class FileDestination: BaseQueuedDestination {
    ...
    private func openFile() {
        ...
        let logDetails = LogDetails(level: .info, date: Date(), message: "XCGLogger " + (fileExists && shouldAppend ? "appending" : "writing") + " log to: " + writeToFileURL.absoluteString, functionName: "", fileName: "", lineNumber: 0, dso: #dsohandle, userInfo: XCGLogger.Constants.internalUserInfo)
